...
import rocks.zipcode.repository.MessageRepository;
import rocks.zipcode.service.dto.MessageDTO;
import rocks.zipcode.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().text(DEFAULT_TEXT);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().text(UPDATED_TEXT);
        return message;
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.text(UPDATED_TEXT);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.text(UPDATED_TEXT);

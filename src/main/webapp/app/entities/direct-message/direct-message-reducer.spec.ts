...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIRECTMESSAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIRECTMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIRECTMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIRECTMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIRECTMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIRECTMESSAGE actions', async () => {
      const expectedActions = [
        {

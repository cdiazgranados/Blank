...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBERSHIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEMBERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEMBERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEMBERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEMBERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEMBERSHIP actions', async () => {
      const expectedActions = [
        {

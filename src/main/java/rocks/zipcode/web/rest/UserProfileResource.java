...
import rocks.zipcode.service.UserProfileService;
...
public class UserProfileResource {
    ...
    public List<UserProfileDTO> getAllUserProfiles(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {

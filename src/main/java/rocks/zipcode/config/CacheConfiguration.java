...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, rocks.zipcode.domain.Membership.class.getName());
            createCache(cm, rocks.zipcode.domain.Membership.class.getName() + ".messages");
            ...
            createCache(cm, rocks.zipcode.domain.DirectMessage.class.getName() + ".users");
            createCache(cm, rocks.zipcode.domain.Channel.class.getName());
            createCache(cm, rocks.zipcode.domain.Channel.class.getName() + ".messages");
            createCache(cm, rocks.zipcode.domain.Channel.class.getName() + ".memberships");
